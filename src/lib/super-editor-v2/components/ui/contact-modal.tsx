      ...
      {phone ? (
        <div className="flex gap-2">
          <button
            type="button"
            onClick={() => onSms(phone)}
            className="flex-1 py-2.5 px-4 bg-gray-200 hover:bg-gray-300 text-gray-700 rounded-lg text-sm font-medium transition-colors"
          >
            문자 보내기
          </button>
          <button
            ...
            className="flex-1 py-2.5 px-4 bg-gray-700 hover:bg-gray-800 text-white rounded-lg text-sm font-medium transition-colors"
          >
            전화하기
          </button>
        </div>
