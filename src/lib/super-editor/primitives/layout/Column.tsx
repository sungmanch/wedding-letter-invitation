...
import type { PrimitiveNode, ColumnProps } from '../../schema/primitives'
...
export function Column({
  ...
  const props = getNodeProps<ColumnProps>(node)
...
export const columnRenderer: PrimitiveRenderer<ColumnProps> = {
  type: 'column',
  render: (node, context) => (
    <Column key={node.id} node={node} context={context} />
  ),
  editableProps: [
    {
      key: 'gap',
