...
const MOOD_KEYWORDS: Record<string, string[]> = {
  romantic: ['로맨틱', '낭만', '사랑스러운', '달달', '러블리'],
  elegant: ['우아', '고급', '세련', '클래식', '품격', '격조'],
  minimal: ['미니멀', '심플', '깔끔', '단순', '간결'],
  modern: ['모던', '현대적', '트렌디', '세련된'],
  warm: ['따뜻', '포근', '아늑', '온화'],
  luxury: ['럭셔리', '화려', '프리미엄', '고급스러운'],
}

const COLOR_KEYWORDS: Record<string, string[]> = {
  'white-gold': ['화이트', '골드', '금색', '흰', '하얀', '금빛', '황금'],
  'blush-pink': ['핑크', '분홍', '로즈', '연분홍', '살구'],
  'deep-navy': ['네이비', '남색', '블루', '파란', '진청'],
  'natural-green': ['그린', '초록', '녹색', '자연', '숲'],
  'terracotta': ['테라코타', '브라운', '갈색', '베이지', '흙빛'],
}
